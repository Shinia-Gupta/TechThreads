...
<Footer.Link href='/about' target='_blank' rel='noopener noreferrer'>Tech Threads </Footer.Link>
                        </Footer.LinkGroup>
                        </div>
                        <div>
                        <Footer.Title title='Follow Me'/>
                        <Footer.LinkGroup col>
<Footer.Link href='https://github.com/Shinia-Gupta' target='_blank' rel='noopener noreferrer'>Github </Footer.Link>
...
<Footer.Link href='#' target='_blank' rel='noopener noreferrer'>Terms & Conditions </Footer.Link>
                ...
                <div className='w-full sm:flex sm:justify-between sm:items-center'>
                    <Footer.Copyright href='#' by='Tech Threads' year={new Date().getFullYear()}/>
